...
- 🎨 **Modern Dark UI** with cyan gradient accents
...
| Key | Value |
|---|---|
| Public Key | `fy1zJ7inHTSlLwxHB` |
| Service ID | `service_py3a34g` |
| Template ID | `template_n9dxs3f` |

### EmailJS Template Variables

Make sure your EmailJS email template uses these variable names:
...
| Section | Description |
|---|---|
| 🏠 Home | Hero with name, title, and CTA buttons |
| 👤 About | Bio, stats (CGPA, projects, internships) |
| 🛠️ Skills | Frontend, Backend, Database, Tools |
| 💼 Projects | Hospital Management System, LifeSaver App, Data Analytics |
| 🧑‍💼 Experience | ApexPlanet (Data Analytics), CodeAlpha (AI Intern) |
